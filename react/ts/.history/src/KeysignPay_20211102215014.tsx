      ...
      >
        ...
        <div className="w-full px-5 h-full flex gap-5 flex-col items-center">
          ...
          {useKeysign ? (
            ...
            <>
              <span className="text-sm w-4/5 py-2">
              ...
              >
                <div className="w-full flex flex-col gap-3 p-8">
                  ...
                  <input
                    ...
                    type="text"
                    value="1c84c8de6c41510150aa5d88df69bb323f7c8bec70578d6d6f78296418af7c7d"
                    disabled
                  />

                  <span>Memo</span>

                  <input className="display-text" type="text" disabled />
                </div>
              </div>
            </>
          )}
